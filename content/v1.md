...
Please note that you must [register your application](https://dribbble.com/account/applications/new)
and use your API key when making requests. Before doing so, be sure to read
our [Terms &amp; Guidelines](/terms/) to learn how the API may be used.
...
The structure of this documentation is based on the
[GitHub Developer](https://github.com/github/developer.github.com) site.
We thank [GitHub](https://github.com) for their code and their excellent tools
